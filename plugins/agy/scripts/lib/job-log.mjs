 ...
 *
 * Matches cc-plugin-codex's job-log.mjs format for compatibility.
 */
...
export function phaseDescription(phase) {
  switch (phase) {
    ...
    case "executing":   return "Antigravity is working on the task";
...
export function inferPhaseFromLog(logLines) {
  for (let i = logLines.length - 1; i >= 0; i--) {
    ...
    if (line.startsWith("starting") || line.includes("agy -p")) return "starting";
